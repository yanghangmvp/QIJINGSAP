CLASS zzcl_api_mm015 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS ZZCL_API_MM015 IMPLEMENTATION.
  ...
  METHOD inbound.
    ...
    "循环处理
    LOOP AT ls_data-bill-billbody-entry INTO DATA(ls_entry).
      ...
      ls_orgplant-taxcode  = ls_entry-mwskz.
...
*      ls_orgplant-materialpriceunitqty  = ls_entry-peinh.
      ...
      ls_orgplant-condition-conditionisdeleted = ls_entry-loevm_ko.
