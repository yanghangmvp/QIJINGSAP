CLASS lhc_mm002 DEFINITION INHERITING FROM cl_abap_behavior_handler.
  PRIVATE SECTION.

    METHODS get_instance_features FOR INSTANCE FEATURES
      IMPORTING keys REQUEST requested_features FOR mm002 RESULT result.

    METHODS get_instance_authorizations FOR INSTANCE AUTHORIZATION
      IMPORTING keys REQUEST requested_authorizations FOR mm002 RESULT result.

    METHODS read FOR READ
      IMPORTING keys FOR READ mm002 RESULT result.

    METHODS lock FOR LOCK
      IMPORTING keys FOR LOCK mm002.

    METHODS zpush FOR MODIFY
      IMPORTING keys FOR ACTION mm002~zpush RESULT result.

ENDCLASS.

CLASS lhc_mm002 IMPLEMENTATION.
...
CLASS lsc_zc_query_mm002 DEFINITION INHERITING FROM cl_abap_behavior_saver.
  PROTECTED SECTION.
...
CLASS lsc_zc_query_mm002 IMPLEMENTATION.
